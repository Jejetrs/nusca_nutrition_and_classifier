      ...
      <div className="ns-result">
        <div className="ns-result-header">
          <div>
            ...
            <div className="ns-meta">Tidak terdeteksi label gizi</div>
          </div>
        </div>
        <div className="ns-alert">
          <div className="ns-alert-head">
            <span className="ns-alert-ic"><WarnIcon /></span>
            Bukan label Informasi Nilai Gizi
          </div>
          <div className="ns-alert-body">
            <div>
              Gambar yang diunggah tidak dikenali sebagai tabel <b>Informasi Nilai Gizi</b>.
              Pastikan foto mencakup seluruh tabel gizi (takaran saji, gula, garam, lemak jenuh)
              dan teksnya terbaca jelas, lalu coba lagi.
            </div>
          </div>
        </div>
        <div className="ns-result-footer">
          <button className="ns-btn blue lg" onClick={onRestart}>
            <ReturnIcon /> Coba Foto Lain
          </button>
        </div>
      </div>
    )
